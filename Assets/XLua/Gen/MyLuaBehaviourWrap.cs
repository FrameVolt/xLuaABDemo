...
namespace XLua.CSObjectWrap
{
    ...
    public class MyLuaBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MyLuaBehaviour);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					MyLuaBehaviour gen_ret = new MyLuaBehaviour();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MyLuaBehaviour constructor!");
        ...
        static int _g_get_luaScript(RealStatePtr L)
        {
		    try {
                ...
                MyLuaBehaviour gen_to_be_invoked = (MyLuaBehaviour)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_injections(RealStatePtr L)
        {
		    try {
                ...
                MyLuaBehaviour gen_to_be_invoked = (MyLuaBehaviour)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.injections = (MyInjection[])translator.GetObject(L, 2, typeof(MyInjection[]));
