...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp13(UnityEngine.MonoBehaviour p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp15(UnityEngine.Vector3 p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<UnityEngine.MonoBehaviour>(__Gen_Delegate_Imp13);
			}
			...
			{
			    return new System.Action<UnityEngine.Vector3>(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(DG.Tweening.Core.DOSetter<UnityEngine.Vector3>))
			{
			    return new DG.Tweening.Core.DOSetter<UnityEngine.Vector3>(__Gen_Delegate_Imp15);
			}
